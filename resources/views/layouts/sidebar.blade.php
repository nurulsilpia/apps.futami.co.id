...
{{-- <div class="main-sidebar"> --}}
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="menu-header"></li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="far fa-file-alt"></i> <span>Produksi</span></a>
                <ul class="dropdown-menu">
              ...
              <li class="menu-header"></li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="far fa-file-alt"></i> <span>Engineering</span></a>
                <ul class="dropdown-menu">
                   <li><a class="nav-link" href="#">Downtime</a></li>
                </ul>
              </li>
              ...
              <li class="menu-header"></li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="far fa-file-alt"></i> <span>PPIC</span></a>
                <ul class="dropdown-menu">
