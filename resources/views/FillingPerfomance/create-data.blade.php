        ...
        <div class="card p-3">
            <form action="{{route('FillingPerfomance.store')}}" method="POST" class="mx-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="counter_filling" class="form-control @error('counter_filling') is invalid @enderror" placeholder="Masukan Counter Filling" value="{{old('id_product')}}">
